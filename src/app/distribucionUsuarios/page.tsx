                ...
                <NavBar
                    ...
                    <PopUpWindow open={distributionType !== null} onClose={cerrarPopup}>
                        <h2 className="text-lg font-bold mb-4">
                            ¿Estás seguro de que deseas confirmar la distribución {distributionType}?
                        </h2>
                    ...
                    <PopUpWindow open={showDownloadPopup} onClose={cerrarPopupDescarga} width="max-w-5xl">
                        <div className="max-w-none w-full max-h-[90vh] overflow-auto">
                                    ...
                                    <thead>
                                        <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                                            ...
                                            <th className="border-b-2 border-gray-200 px-8 py-4 text-left font-bold text-gray-700 text-base min-w-[400px]">
                                                {currentDistributionType === "manual" ? "Asignar Destino" : "Destino Asignado"}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {productosDistribucion.map((producto, index) => (
                                            ...
                                            <td className="border-b border-gray-100 px-8 py-5">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    onChange={(e) => handleLocationAssignment(index, e.target.value)}
                                                ...
                                                <div className="px-5 py-3 bg-green-50 border-2 border-green-200 rounded-lg">
                                                    ...
                                                    {usuariosPrueba[Math.floor(Math.random() * usuariosPrueba.length)].nombre}
                                                    </div>
                                                </div>
                                                )}
                                            </td>
                            ...
                            <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                                ...
                                <motion.button
                                    ...
                                    disabled={currentDistributionType === "manual" && Object.keys(productDistributions).length === 0}
                                >
                                    <Download size={20} />
                                    {currentDistributionType === "manual" ? "Generar Distribución" : "Descargar PDF"}
                                </motion.button>
                            </div>
                        </div>
                    </PopUpWindow>
