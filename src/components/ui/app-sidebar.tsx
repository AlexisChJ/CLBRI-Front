...
export function AppSidebar() {
  ...
  return (
    ...
    >
      <SidebarContent className="flex flex-col h-full bg-black text-white transition-all duration-500 ease-in-out">
        ...
        <div className="relative flex-1">
          <div className="absolute top-1/2 left-0 w-full -translate-y-1/2 transition-all duration-500 ease-in-out">
        ...
        <div className="h-[80px] flex items-center justify-center w-full transition-all duration-500">
          <button
